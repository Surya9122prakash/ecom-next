          ...
          <div className="flex items-center gap-2">
            ...
            {session ? (
              <div className="sm:flex sm:gap-2 border-r border-primary pr-4">
                <div className="w-9 h-9 pt-2 pr-20">
                  {session && (
      ...
      {isMobileNavOpen && (
        <div className="md:hidden">
          <nav className="flex flex-col gap-2 px-4 py-4">
            <Link className={`text-primary transition ${pathname === '/' ? 'font-bold' : ""} `} href="/">Home</Link>
            <Link className={`text-primary transition ${pathname === '/products' ? 'font-bold' : ""} `} href="/products">All Products</Link>
            <Link className={`text-primary transition ${pathname === '/cart' ? 'font-bold' : ""} `} href="/cart">Cart</Link>
          </nav>
        </div>
      )}
    </header>
